...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/KittenYang/KYElegantPhotoGallery"
  ...
  s.source       = { :git => "https://github.com/KittenYang/KYElegantPhotoGallery.git", :tag => s.version.to_s }
  ...
  s.source_files  = "KYElegantPhotoGallery-Demo/Classes/**/*.{h,m}"
